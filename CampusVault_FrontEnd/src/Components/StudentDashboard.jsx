...
//   // ✅ warning badge count — unread warnings
...
//                                      text-[#26F2D0] border border-[#26F2D0]/20
...
//           <button
//             className={tabClass("activity")}
//             onClick={() => { setActiveTab("activity"); if (unread > 0) markAllRead(); }}
//           >
//             Activity
//             {/* ✅ show teal badge for notifications, red for warnings */}
//             {unread > 0 && (
//               <span className="ml-2 bg-[#26F2D0] text-black text-xs px-2 py-0.5 rounded-full font-bold">
//                 {unread > 9 ? "9+" : unread}
//               </span>
