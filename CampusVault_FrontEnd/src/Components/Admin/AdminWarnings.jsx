...
export default function AdminWarnings({ token, students }) {
  ...
  const issueWarning = async () => {
    ...
    setSending(true);
    try {
      const res = await fetch(`${API_BASE}/api/warnings/issue`, {
        method: "POST", headers,
        body: JSON.stringify({
  ...
  const fetchSuggestions = async () => {
    ...
    try {
      const res = await fetch(`${API_BASE}/api/warnings/suggestions`, { headers });
  ...
  const approveSuggestion = async (id) => {
    const res = await fetch(`${API_BASE}/api/warnings/${id}/approve`, {
      method: "POST", headers,
    });
  ...
  const deleteSuggestion = async (id) => {
    const res = await fetch(`${API_BASE}/api/warnings/${id}`, {
