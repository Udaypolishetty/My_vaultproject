...
//       : !notif.read
//       ? "text-white font-extrabold drop-shadow-[0_0_6px_rgba(38,242,208,0.35)]"
  ...
  const handleClearAllNotifications = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        console.error("Failed to clear notifications:", await res.text());
      }
    } catch (err) {
      console.error("Clear all notifications failed:", err);
    } finally {
          ...
          <div className="flex items-center justify-between">
            ...
            >
              {clearing ? (
                ...
                <><Trash2 size={12} /> Clear All ({notifications.length})</>
              )}
            </button>
          </div>
              ...
              return (
                <div key={notif.id} className={`
                  ...
                  ${isWarning
                    ? "bg-red-500/5 border-red-500/20"
                    : isUnread
                      /* ── UNREAD: clearly white/bright, visible border ── */
                ...
                `}>
                  ...
                  <div className={`
                    ...
                    ${isWarning ? "bg-red-500/10" : isUnread ? "bg-white/10" : "bg-white/[0.04]"}
                  `}>
                    {iconMap[notif.type] || <Bell size={16} className="text-gray-400" />}
                  </div>
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-start justify-between gap-2">
                      <p className={`
                        ...
                        ${isWarning
                          ? "text-red-300 font-semibold"
                          : isUnread
                            /* ── UNREAD text: pure white, semibold ── */
                            ? "text-white font-semibold"
                            /* ── READ text: noticeably dimmer ── */
                    ...
                    <div className="flex items-center gap-2 mt-1.5 flex-wrap">
                      ...
                      {/* Unread dot */}
                      {isUnread && !isWarning && (
                        <span className="w-1.5 h-1.5 rounded-full bg-[#26F2D0] shrink-0" />
                      )}
