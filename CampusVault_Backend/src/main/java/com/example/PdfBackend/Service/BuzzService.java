...
//         post.setExpiresAt(LocalDateTime.now().plusDays(2)); // ✅ auto-delete after 7 days
//         post.setLikes(0);
...
//         // ✅ one reply per student per post
...
//     // ✅ auto cleanup — runs every day at 1am
