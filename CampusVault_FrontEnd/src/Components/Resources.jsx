...
// import MobileViewResource from "./MobileViewResource";
// import React, { useState,useEffect } from "react";

// import {
//   FileText, BookOpen, Upload, Search,
//   Download, Eye, Send, ChevronRight,
...
//   const [type,    setType]    = useState(""); // "papers" | "notes"
...
//   const canSubmit = type && subject.trim().length >= 3 && status !== "sending";
...
//     /* Build notification message — admins/mods see this in their SSE stream */
//     const message =
//       `📚 Contribute Request · ${type === "papers" ? "Papers" : "Notes"} ` +
...
//     try {
//       /*
//         POST /api/notifications/broadcast  — notify ALL admins + moderators.
//         Your NotificationService.create() already exists; we use the
//         /api/notifications/broadcast endpoint (add it below in the backend note).
//         If you'd rather reuse buzz: POST /api/buzz works too — see backend note.
//       */
//       const res = await fetch("http://localhost:8081/api/notifications/broadcast", {
//         method: "POST",
//         headers: {
...
//         setErrMsg(txt || "Server error. Try again.");
//         setStatus("error");
//       }
//     } catch {
//       setErrMsg("Could not reach server. Check connection.");
//       setStatus("error");
//     }
//   };
...
//         flex: 1, gap: 16, textAlign: "center", padding: "48px 24px",
//       }}>
//         <div style={{
...
//             Admin and moderators have been notified. They'll review your contribution soon.
//           </p>
//         </div>
//       </div>
//     );
...
//       {/* heading */}
//       <div>
//         <h3 style={{ color: "white", fontWeight: 800, fontSize: 22, margin: "0 0 6px", letterSpacing: "-0.03em" }}>
//           Contribute Resources
//         </h3>
//         <p style={{ color: "#6b7280", fontSize: 13, margin: 0, lineHeight: 1.6 }}>
//           Got papers or notes to share? Let us know — admin will review and upload them.
//         </p>
//       </div>
...
//           {[
//             { key: "papers", label: "📄 Question Papers", desc: "Previous year exam papers" },
//             { key: "notes",  label: "📝 Study Notes",     desc: "Subject notes or handouts" },
//           ].map(opt => (
//             <button
//               key={opt.key}
...
//                 border: `1px solid ${type === opt.key ? "rgba(38,242,208,0.4)" : "rgba(255,255,255,0.08)"}`,
//                 background: type === opt.key ? "rgba(38,242,208,0.08)" : "rgba(255,255,255,0.03)",
//                 textAlign: "left", transition: "all 0.2s",
//                 boxShadow: type === opt.key ? "0 0 16px rgba(38,242,208,0.1)" : "none",
//               }}
//             >
//               <p style={{ color: type === opt.key ? "#26F2D0" : "white",
//                 fontWeight: 600, fontSize: 13, margin: "0 0 3px" }}>
//                 {opt.label}
//               </p>
//               <p style={{ color: "#6b7280", fontSize: 11, margin: 0 }}>{opt.desc}</p>
//             </button>
//           ))}
//         </div>
//       </div>
...
//           placeholder="e.g. Data Structures, Engineering Maths 2..."
//           maxLength={120}
//           style={{
//             width: "100%", padding: "12px 16px", borderRadius: 12,
//             background: "rgba(255,255,255,0.04)",
//             border: `1px solid ${subject.trim().length > 0 ? "rgba(38,242,208,0.3)" : "rgba(255,255,255,0.09)"}`,
//             color: "white", fontSize: 14, outline: "none",
//             transition: "border-color 0.2s", boxSizing: "border-box",
//           }}
//           onFocus={e  => e.target.style.borderColor = "rgba(38,242,208,0.5)"}
//           onBlur={e   => e.target.style.borderColor = subject.trim().length > 0 ? "rgba(38,242,208,0.3)" : "rgba(255,255,255,0.09)"}
//         />
//       </div>
...
//         <label style={{ fontSize: 12, color: "#9ca3af", fontWeight: 600,
//           letterSpacing: "0.06em", textTransform: "uppercase", display: "block", marginBottom: 8 }}>
//           Additional Details <span style={{ color: "#4b5563", fontWeight: 400, textTransform: "none" }}>(optional)</span>
//         </label>
//         <textarea
//           value={details}
//           onChange={e => setDetails(e.target.value)}
//           placeholder="Regulation year, semester, how you can share (Google Drive, WhatsApp, etc.)..."
//           rows={3}
//           maxLength={300}
//           style={{
//             width: "100%", padding: "12px 16px", borderRadius: 12,
...
//           background: "rgba(38,242,208,0.12)",
//           border: "1px solid rgba(38,242,208,0.2)",
//           display: "flex", alignItems: "center", justifyContent: "center",
//           fontSize: 13, fontWeight: 700, color: "#26F2D0", flexShrink: 0,
//         }}>
...
//             {rollNumber}{year ? ` · Year ${year}` : ""}{branch ? ` · ${branch}` : ""}
//             <span style={{ color: "#374151", marginLeft: 6 }}>— will be sent with request</span>
//           </p>
//         </div>
//       </div>
...
//           <p style={{ color: "#f87171", fontSize: 12, margin: 0 }}>{errMsg}</p>
...
//             ? "linear-gradient(135deg, rgba(38,242,208,0.2), rgba(38,242,208,0.1))"
//             : "rgba(255,255,255,0.04)",
//           border: `1px solid ${canSubmit ? "rgba(38,242,208,0.4)" : "rgba(255,255,255,0.08)"}`,
//           color: canSubmit ? "#26F2D0" : "#374151",
//           transition: "all 0.2s",
//           boxShadow: canSubmit ? "0 0 20px rgba(38,242,208,0.12)" : "none",
//         }}
//         onMouseEnter={e => { if (canSubmit) { e.currentTarget.style.background = "rgba(38,242,208,0.18)"; e.currentTarget.style.boxShadow = "0 0 24px rgba(38,242,208,0.2)"; }}}
//         onMouseLeave={e => { if (canSubmit) { e.currentTarget.style.background = "linear-gradient(135deg,rgba(38,242,208,0.2),rgba(38,242,208,0.1))"; e.currentTarget.style.boxShadow = "0 0 20px rgba(38,242,208,0.12)"; }}}
//       >
//         {status === "sending"
...
//       <p style={{ fontSize: 11, color: "#374151", textAlign: "center", margin: 0 }}>
//         Admin and all moderators will receive a notification instantly.
//       </p>
...
//         .res-file-row:hover { background: rgba(38,242,208,0.05) !important; border-color: rgba(38,242,208,0.2) !important; }
//         .res-tab-btn { transition: all 0.2s ease; }
//         .res-domain-opt { color: white; }
//         ::-webkit-scrollbar { width: 4px; }
//         ::-webkit-scrollbar-track { background: transparent; }
//         ::-webkit-scrollbar-thumb { background: rgba(255,255,255,0.1); border-radius: 4px; }
//       `}</style>

//       <div className="res-wrap" style={{
...
//               </p>
//               <p style={{ color: "#4b5563", fontSize: 11, margin: "2px 0 0" }}>
//                 {papers.length} file{papers.length !== 1 ? "s" : ""} available
//               </p>
//             </div>
//           )}
...
//               All materials are shared for academic purposes only. Report incorrect or missing files to admin.
//             </p>
//           </div>
//         </aside>
...
//             <h2 style={{
//               fontFamily: "'Sora',sans-serif", fontWeight: 800,
//               fontSize: 24, color: "white", margin: "0 0 20px",
...
//                 const isContribute = tab.key === "contribute";
//                 return (
//                   <button
//                     key={tab.key}
...
//                       background: active
//                         ? isContribute
//                           ? "rgba(38,242,208,0.08)"
//                           : "rgba(255,255,255,0.05)"
//                         : "transparent",
//                       color: active
//                         ? isContribute ? "#26F2D0" : "white"
//                         : "#6b7280",
...
//                         background: isContribute
//                           ? "linear-gradient(90deg,#26F2D0,#7c3aed)"
//                           : "#26F2D0",
...
//                 {/* empty — no domain */}
//                 {!domain && (
//                   <div style={{ color: "#4b5563", fontSize: 14, paddingTop: 8 }}>
//                     ← Select a domain from the sidebar to view papers
//                   </div>
//                 )}
...
//                     <Loader2 size={16} style={{ animation: "spin 1s linear infinite", color: "#26F2D0" }} />
//                     Loading files...
//                   </div>
//                 )}
...
//                               display: "flex", alignItems: "center", justifyContent: "center",
//                             }}>
//                               <FileText size={15} style={{ color: "#26F2D0" }} />
//                             </div>
//                             <span
...
//                                 transition: "all 0.2s",
//                               }}
//                               onMouseEnter={e => { e.currentTarget.style.background = "rgba(38,242,208,0.2)"; }}
//                               onMouseLeave={e => { e.currentTarget.style.background = "rgba(38,242,208,0.1)"; }}
//                             >
...
//                     margin: "0 auto 16px",
//                   }}>
//                     <BookOpen size={24} style={{ color: "#26F2D0" }} />
//                   </div>
//                   <h3 style={{
//                     fontFamily: "'Sora',sans-serif", fontWeight: 800,
//                     fontSize: 20, color: "white", margin: "0 0 8px", letterSpacing: "-0.02em",
//                   }}>
//                     Notes Section
//                   </h3>
//                   <p style={{ color: "#6b7280", fontSize: 13, lineHeight: 1.6, margin: "0 0 16px" }}>
//                     We're working on adding curated notes for each subject and regulation.
//                   </p>
//                   <span style={{
...
//                     Temporarily access notes from the link below:
//                   </p>
//                   <button
//                     onClick={() => window.open(
//                       "https://www.forum.universityupdates.in/threads/jntuh-study-materials-notes-important-questions.33519/",
...
//                     }}
//                     onMouseEnter={e => { e.currentTarget.style.background = "rgba(38,242,208,0.1)"; e.currentTarget.style.color = "#26F2D0"; e.currentTarget.style.borderColor = "rgba(38,242,208,0.3)"; }}
//                     onMouseLeave={e => { e.currentTarget.style.background = "rgba(255,255,255,0.05)"; e.currentTarget.style.color = "white"; e.currentTarget.style.borderColor = "rgba(255,255,255,0.1)"; }}
//                   >
//                     Open Notes ↗
//                   </button>
//                 </div>
