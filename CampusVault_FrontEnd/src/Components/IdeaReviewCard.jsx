  ...
  return (
    <div className={`bg-[#111] border rounded-2xl p-5 transition-all duration-200
      ${isReviewing
        ...
        {/* ✅ Stamp overlay for implemented/rejected */}
  {(idea.status === "IMPLEMENTED" || idea.status === "REJECTED" || idea.status === "ON_HOLD") && !isReviewing && (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10">
      <div className={`rotate-[-20deg] border-4 rounded-2xl px-6 py-3 opacity-20
        ...
        <p className={`text-4xl font-black tracking-widest uppercase
          ...
          {idea.status === "IMPLEMENTED" ? "✅ Done"
            : idea.status === "ON_HOLD" ? "⏸ Hold"
            : "❌ Rejected"}
        </p>
      </div>
    </div>
